...
import { CATEGORIES, type CategoryId } from "../_lib/questions";
import {
...
} from "../_lib/game-engine";
import { AR, DIFFICULTY_LABELS_AR } from "../_lib/i18n";
      ...
      {Array.from({ length: 20 }).map((_, i) => (
        <div
          ...
          style={{
            ...
            animation: `quiz-confettiFall ${1 + Math.random()}s ease-out forwards`,
