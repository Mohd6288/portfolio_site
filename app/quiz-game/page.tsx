...
import { getLeaderboard, type LeaderEntry } from "./_lib/leaderboard";
    ...
    <div className="fade-up">
      ...
      <section className="relative overflow-hidden border-b border-[var(--border)]">
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                opacity: 0.2,
                animation: `quiz-particleFloat ${8 + i * 2}s linear ${i * 1.5}s infinite`,
              }}
            />
          ))}
        </div>
        ...
        <div className="max-w-5xl mx-auto px-5 py-24 text-center relative z-10">
          ...
          <Link href="/quiz-game#categories" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl text-white text-sm font-bold shadow-lg hover:scale-[1.03] transition-all pulse-glow" style={{ background: "var(--accent)" }}>
            &#127466;&#127480; Start Playing
          </Link>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-5 py-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {CATEGORIES.map((c) => (
              <Link
                key={c.id}
                href={`/quiz-game/story?category=${c.id}`}
