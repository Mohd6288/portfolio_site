...
export default function StyleCameraHome() {
  return (
      ...
      <section className="relative overflow-hidden border-b border-[var(--border)]">
        ...
        <div className="max-w-5xl mx-auto px-5 py-24 text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/style-camera/studio" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-[var(--accent)] text-white text-sm font-bold shadow-lg hover:bg-[var(--accent2)] hover:scale-[1.03] transition-all" style={{ animation: "sc-pulseGlow 3s ease-in-out infinite" }}>
              &#127912; Open AI Studio
            </Link>
          </div>
        </div>
      ...
      <section className="border-t border-[var(--border)] bg-[var(--surface)]/50">
        <div className="max-w-5xl mx-auto px-5 py-16">
          ...
          <div className="text-center mt-10">
            <Link href="/style-camera/studio" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[var(--accent)] text-white text-sm font-bold hover:bg-[var(--accent2)] transition-all">
