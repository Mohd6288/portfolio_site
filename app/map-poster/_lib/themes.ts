...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    name: "Copper Patina",
    description:
      "Oxidized copper aesthetic - teal-green patina with copper accents",
    bg: "#E8F0F0",
    text: "#2A5A5A",
  ...
  },
  {
    ...
    name: "Gradient Roads",
    description:
      "Smooth gradient from dark center to light edges with subtle features",
    bg: "#FFFFFF",
    text: "#000000",
    gradient_color: "#FFFFFF",
    water: "#D5D5D5",
  ...
  },
  {
    ...
    name: "Japanese Ink",
    description:
      "Traditional ink wash inspired - minimalist with subtle red accent",
    bg: "#FAF8F5",
    text: "#2C2C2C",
  ...
  },
  {
    ...
    description:
      "Single blue color family with varying saturation - clean and cohesive",
    bg: "#F5F8FA",
    text: "#1A3A5C",
  ...
  },
  {
    ...
    name: "Pastel Dream",
    description:
      "Soft muted pastels with dusty blues and mauves - dreamy artistic aesthetic",
    bg: "#FAF7F2",
    text: "#5D5A6D",
  ...
  },
  {
    ...
    name: "Sunset",
    description:
      "Warm oranges and pinks on soft peach - dreamy golden hour aesthetic",
    bg: "#FDF5F0",
    text: "#C45C3E",
